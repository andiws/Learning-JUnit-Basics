...
private Map <String, Map<Boolean,AtomicInteger>> convertingHistogramIdsToText(
		Map<Integer, Map<Boolean, AtomicInteger>> responses, 
		Map<Integer,String>questions){
	Map<String, Map<Boolean,AtomicInteger>>textRespones = new HashMap<>(); 
...
private void incrementHistogram(
		Map<Integer, Map<Boolean, AtomicInteger>>response, BooleanAnswer answer) {
