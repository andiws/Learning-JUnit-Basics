...
public class QuestionControllerTest {
	...
	@Before
	public void create() {
		contoller = new QuestionController();
		controller.deleteAll();
	}

	@Test
	public void findsPersistedQuestionById9)
	{
		int id = controller.addBooleanQuestion("question text");
		Question question = controller.find(id);
		assertThat(question.getText(), equalTo("questiontext"));
	}
	...
	public void questionAnswersDateAdded() {
		...
		Question question = controller.find(id);
		assertThat(question.createTimestamp(), equalTo(now));
	}

	@Test
	public void answerMultiplePersistedQuestions() {
	...
	public void findsMatchingEntries() {
		...
		controller.addBooleantion("beta 1");
